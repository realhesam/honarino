...
var (
	...
	ErrProductNotFound            = errors.New("محصول پیدا نشد")
	ErrProductSlugTaken           = errors.New("نامک محصول درحال حاضر برای این تولیدی موجود است")
	ErrInvalidProductCategory     = errors.New("دسته بندی محصول نامعتبر است")
	ErrCategoryNotAllowedForShop  = errors.New("این دسته بندی برای این تولیدی مجاز نیست")
	ErrNoCategoriesSelected       = errors.New("حداقل یک دسته بندی باید انتخاب شود")
)
