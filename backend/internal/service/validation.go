...
var (
	...
	ErrCategoryNotFound           = errors.New("دسته بندی یافت نشد")
	ErrParentNotFound             = errors.New("دسته بندی والد یافت نشد")
	ErrSlugTaken                  = errors.New("نامک (slug) قبلاً استفاده شده است")
	ErrCategoryHasChildren        = errors.New("دسته بندی دارای زیر دسته است و ابتدا باید زیر دسته‌ها حذف یا جابه‌جا شوند")
	ErrInvalidParentCircle        = errors.New("دسته بندی والد نمی‌تواند یکی از زیر دسته‌های خودش باشد")
)
