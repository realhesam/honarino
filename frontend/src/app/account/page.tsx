...
function FileInput({ label, inputName, onFileSelect, isFileUploaded }: FileInputProps) {
            ...
            <div className="p-5 grid gap-5 items-start md:grid-cols-[20rem_1fr]">
                <div className="p-5 bg-white rounded-xl border border-stone-200 flex flex-col items-center">
                    <div className="relative size-25 rounded-full overflow-hidden">
                        <img className="bg-cover" src={profile.image} alt="image of the user" />
                    </div>
                    <h3 className="text-xl font-medium text-stone-800 mt-2">{profile.username}</h3>
                    <span className="bg-stone-200 rounded-sm p-1 text-xs text-stone-600">{profile.userType}</span>
            ...
            {passwordModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl p-6">
                        <h3 className="text-xl font-semibold text-stone-900">تغییر کلمه عبور</h3>
                        <p className="text-sm text-stone-600 mt-2">برای حفظ حریم خصوصی خود کلمه عبور خود را هرچند وقت یکبار تغییر دهید.</p>
                        <form onSubmit={handlePasswordSubmit} className="mt-6 space-y-4">
                            <div>
                                <label htmlFor="currentPassword" className="block text-sm text-stone-700 mb-2">رمز فعلی</label>
                                <input
                                    id="currentPassword"
                                    type="password"
                            ...
                            <div>
                                <label htmlFor="newPassword" className="block text-sm text-stone-700 mb-2">رمز جدید</label>
                                <input
                                    id="newPassword"
                                    type="password"
                                    value={newPassword}
                            ...
                            <div>
                                <label htmlFor="confirmPassword" className="block text-sm text-stone-700 mb-2">تکرار رمز جدید</label>
                                <input
                                    id="confirmPassword"
                                    type="password"
