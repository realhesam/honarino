...
const SOCIAL_FIELDS: SocialField[] = [
  {
    ...
    Icon: ({ className }) => <FaTelegram className={className} />,
  },
  {
    key: "rubika",
    label: "روبیکا",
        ...
        {steps.map((s, i) => {
          ...
          return (
            <li key={s.key} className="relative">
              {i !== 0 && (
                <span
                  className={`absolute start-[14px] -top-[10px] w-[2px] h-[22px] ${
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Field id={websiteId} label="وبسایت" error={errors.website}>
        ...
        >
          <HiOutlineGlobeAlt size={18} className="text-gray-400 flex-none" />
          <input
            id={websiteId}
            type="url"
            value={form.website}
...
function ReviewRow({
  ...
  return (
    <div className="flex justify-between items-start gap-3 py-3 border-b border-gray-100 last:border-0">
      ...
      <span className="text-[13.5px] text-gray-800 font-medium flex-1 wrap-break-word">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-[clamp(20px,3vw,36px)] flex flex-col min-h-[480px]">
          ...
          <div className="flex justify-between gap-3 mt-7 pt-5 border-t border-gray-100 max-[560px]:flex-col-reverse">
            ...
            {stepIndex < totalSteps - 1 ? (
              <LinkButton
                type="button"
                customClass={`${BTN_BASE} ${BTN_PRIMARY} max-[560px]:w-full max-[560px]:justify-center`}
                onClick={goNext}
              >
                مرحله بعد
